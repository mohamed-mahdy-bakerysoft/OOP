...
public class XYZView{
	...
	// Hier ergaenzen
    	...
    	public XYZView(Stage primaryStage,XYZControl seControl,  BuergeraemterModel model){
    		Scene scene = new Scene(this.pane, 560, 340);
    		primaryStage.setScene(scene);
    		primaryStage.setTitle("Anzeige von XYZ Einrichtungen");
    		primaryStage.show();
    		// Hier ergaenzen
...
//    }
    ...
    public void zeigeBuergeraemterAn(){
    		if(buergeraemterModel.getBuergeramt() != null){
    			txtAnzeigeBuergeraemter.setText(buergeraemterModel.getBuergeramt().gibBuergeramtZurueck(' '));
    		}else{
    			zeigeInformationsfensterAn("Bisher wurde kein Bürgeramt aufgenommen!");
    		}
    }	
   
    private void zeigeInformationsfensterAn(String meldung){new MeldungsfensterAnzeiger(AlertType.INFORMATION,
